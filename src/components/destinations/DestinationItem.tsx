...
const DestinationItem = ({ destination, image }: DestinationItemProps) => {
  return (
    <div
      className={`flex flex-col w-full md:w-[314px] h-[457px] rounded-[24px] relative overflow-hidden bg-no-repeat bg-cover mb-[32px] md:mb-0 bg-[url('assets/images/destinations/${image}.png')] ${styles.item}`}
    >
